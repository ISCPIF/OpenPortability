...
def test_dm(recipient_handle):
    ...
    try:
        ...
        # Message de test
        message = "👋 Ceci est un message de test de HelloQittoX. Si vous recevez ce message, cela signifie que nous pouvons vous envoyer des informations par DM. Merci de faire partie de notre communauté !"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 testDm.py <recipient_handle>")
        sys.exit(1)
    
    recipient_handle = sys.argv[1]
    test_dm(recipient_handle)